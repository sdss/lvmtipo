...
try:
    from lvmtipo import __version__
except ModuleNotFoundError:
    from sdsstools import get_package_version
    __version__ = get_package_version(__file__, 'sdss-lvmtipo') or 'dev'
...
.. |lvmtipo_version| replace:: {__version__}
"""
...
htmlhelp_basename = '{0}pdoc'.format('lvmtipo')
...
man_pages = [
    (master_doc, 'lvmtipo', u'{0} Documentation'.format(project),
     [author], 1)
]
...
if use_releases == 'yes':
    ...
    releases_github_path = 'wasndas/lvmtipo'
